...
```javascript
import { isAllowedDataTypeCast, isBufferLengthCompatible, isBufferLengthCompatibleShape, isCastingMode, isColumnMajor, isColumnMajorContiguous, isContiguous, isDataType, isIndexMode, isOrder, isReadOnly, isRowMajor, isRowMajorContiguous, isSafeDataTypeCast, isSameKindDataTypeCast, isSingleSegmentCompatible } from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-assert@esm/index.mjs';
```
