...
*/
setReadOnly( ns, 'isBinaryDataType', require( '@stdlib/ndarray-base-assert-is-binary-data-type' ) );
...
*/
setReadOnly( ns, 'isComplexFloatingPointDataTypeChar', require( '@stdlib/ndarray-base-assert-is-complex-floating-point-data-type-char' ) );
...
*/
setReadOnly( ns, 'isGenericDataType', require( '@stdlib/ndarray-base-assert-is-generic-data-type' ) );
